node{
    ...
    stage('git code checkout'){
        try{
            ...
            git branch: 'main', url: 'https://github.com/devopsmvc/insureme-selenium-test.git'
        }
        catch(Exception e){
    ...
    stage('Containerize the application'){
        ...
        sh "${dockerCMD} build -t devopsmvc/insureme-selenium:${tagName} ."
    }
    ...
    stage('Pushing it ot the DockerHub'){
        ...
        sh "${dockerCMD} push devopsmvc/insureme-selenium:${tagName}"
